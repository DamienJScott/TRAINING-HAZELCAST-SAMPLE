package com.hc.ms.generated.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("HC-SAMPLE-MS-B");
        ...
        config.getMapConfigs().put("com.hc.ms.generated.domain.*", initializeDomainMapConfig(jHipsterProperties));
