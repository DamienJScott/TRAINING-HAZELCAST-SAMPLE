package com.hc.ms.generated.config.timezone;

import com.hc.ms.generated.HcSampleMsBApp;
import com.hc.ms.generated.repository.timezone.DateTimeWrapper;
import com.hc.ms.generated.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = HcSampleMsBApp.class)
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM hc_date_time_wrapper where id=%d", fieldName, id);
    }
