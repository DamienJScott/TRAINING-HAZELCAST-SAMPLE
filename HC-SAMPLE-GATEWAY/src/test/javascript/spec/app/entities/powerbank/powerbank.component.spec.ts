...
import { PowerbankComponent } from 'app/entities/powerbank/powerbank.component';
...
describe('Component Tests', () => {
  describe('Powerbank Management Component', () => {
    let comp: PowerbankComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PowerbankComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.powerbanks && comp.powerbanks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
