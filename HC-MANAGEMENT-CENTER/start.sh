...
if [ $# -eq 4 ] ; then
    ...
    java -cp "hazelcast-mancenter-3.12.9.war:$3" Launcher "$1" "$2"
elif [ $# -eq 3 ] ; then
    java -cp "hazelcast-mancenter-3.12.9.war:$3" Launcher "$1" "$2"
elif [ $# -eq 2 ] ; then
    java -cp hazelcast-mancenter-3.12.9.war Launcher "$1" "$2"
else
    java -cp hazelcast-mancenter-3.12.9.war Launcher
fi
